...
fun downloadMagnetContentExample() {
...
fun downloadTorrentForMagnetExample() {
    val targetDirectory = File("/Users/ksukhyani/Downloads")
...
//    downloadTorrentContentWithFileSelectorExample()
    downloadTorrentContentSequentiallyExample()

    //todo add an example for serial download
}